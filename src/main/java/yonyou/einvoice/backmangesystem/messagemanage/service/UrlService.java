...
import yonyou.einvoice.backmangesystem.messagemanage.dao.UrlDao;
...
public class UrlService {
    ...
    public String selectList(ConditionUtil conditionUtil) {
        try {
            List<CallbackEntity> urllList = urlDao.selectList(conditionUtil);
            int rowAll = urlDao.selectNum(conditionUtil);
            JSONObject object = new JSONObject();
            object.put("list",urllList);
    ...
    public String resend(String fpqqlshs) {
        ...
        jsonObject.put("type", ResendTypeEnum.URL.getTypeNum());
