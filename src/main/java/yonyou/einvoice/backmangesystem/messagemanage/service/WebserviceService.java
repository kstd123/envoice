...
import yonyou.einvoice.backmangesystem.messagemanage.dao.WebserviceDao;
...
public class WebserviceService {
    ...
    public String selectList(ConditionUtil conditionUtil) {
        try {
            List<CallbackEntity> webserviclList = webserviceDao.selectList(conditionUtil);
            int rowAll = webserviceDao.selectNum(conditionUtil);
            JSONObject object = new JSONObject();
            object.put("list",webserviclList);
    ...
    public String resend(String fpqqlshs) {
        ...
        jsonObject.put("type", ResendTypeEnum.WEBSERVICE.getTypeNum());
